...
* ----        ------      ---------  -------   ---------------------                              *
* 20.08.2023  sahira         01      1.0   Original Files, add comments and prolog            *
* 29.08.2023  sahira        02      2.0   Porting to touchgfx 4.6.0                          *
*                                              Use SetUpButtonImage() from ChannelControlPannel   *
*                                                  class                                          *
* 02.09.2023  sahira         03      2.0   Add CallBack and Callback function to deal with    *
*                                                  button insed the control panel                 *
* 02.09.2023  sahira        04      2.0  Re-design interface                                 *
*                                                                                                 *
***************************************************************************************************/
