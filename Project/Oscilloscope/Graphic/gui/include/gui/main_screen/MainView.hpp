...
*                                                                                                 *
*  Change Id Release  Description Of Change                               *
* ----        ------       --------- -------  ---------------------                               *
*  01     1.0 			 Original File, Add Comment and Prolog               *
*  02     2.0  			Porting to touchgfx 4.6.0                           *
*  03     2.0  			Add event handler for button inside control panel   *
*  04     2.0  			Re-design interface                                 *
*                                                                                                 *
**************************************************************************************************/
